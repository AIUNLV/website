  ...
  return (
    <Dialog>
      <DialogTrigger>
        ...
        >
          <span className="absolute top-10 md:left-10 left-6 z-0 md:h-20 md:w-20 h-10 w-10 rounded-full bg-primary transition-all md:duration-500 duration-1000 group-hover:scale-[20]"></span>{" "}
